package com.tanfra.shopmob.smob.ui.planning.shopsAddNewItem
...
class SaveSmobItemATOViewModelTest: AutoCloseKoinTest() {
    ...
    // viewModel
    private lateinit var _viewModelPlanningShopsAddNewItemViewModel: PlanningShopsAddNewItemViewModel
    ...
    fun setupTest() {
        ...
        _viewModelPlanningShopsAddNewItemViewModel = PlanningShopsAddNewItemViewModel(
    ...
    fun `validateEnteredData returns false if title is missing`() {
        ...
        privateTestFun = _viewModelPlanningShopsAddNewItemViewModel.javaClass
        ...
        Assert.assertEquals(false, privateTestFun(_viewModelPlanningShopsAddNewItemViewModel, smobDataATO))
    ...
    fun `validateEnteredData returns true if neither title nor location are missing`() {
        ...
        Assert.assertEquals(true, privateTestFun(_viewModelPlanningShopsAddNewItemViewModel, smobDataATO))
    ...
    fun `validateAndSaveSmobItem stores valid smob item in repository`()  =
        ...
        _viewModelPlanningShopsAddNewItemViewModel.validateAndSaveSmobItem(smobDataATO)
    ...
    fun `validateEnteredData triggers single event showSnackBarInt when title is missing`() {
        ...
        smobDataATO.title = ""
        privateTestFun(_viewModelPlanningShopsAddNewItemViewModel, smobDataATO)
        ...
        //     been deprecated
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.showSnackBarInt.getOrAwaitValue(), equalTo(R.string.err_enter_title))
    ...
    fun `validateEnteredData triggers single event showSnackBarInt when location is missing`() {
        ...
        // --> using assertThat from hamcrest library directly (as org.junit.* 'indirection' has
        //     been deprecated
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.showSnackBarInt.getOrAwaitValue(), equalTo(R.string.err_select_location))
    ...
    fun `setting value in MutableLiveData smobItemTitle triggers LiveData observer`() {
        ...
        _viewModelPlanningShopsAddNewItemViewModel.smobItemTitle.value = "test"

        // THEN the associated LiveData observer should be triggered
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemTitle.getOrAwaitValue(), equalTo("test"))
    ...
    fun `setting value in MutableLiveData smobItemDescription triggers LiveData observer`() {
        ...
        // WHEN...
        // ... setting the value of the LiveData element to be tested
        _viewModelPlanningShopsAddNewItemViewModel.smobItemDescription.value = "test"

        // THEN the associated LiveData observer should be triggered
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemDescription.getOrAwaitValue(), equalTo("test"))
    ...
    fun `setting value in MutableLiveData smobItemSelectedLocationStr triggers LiveData observer`() {
        ...
        // WHEN...
        // ... setting the value of the LiveData element to be tested
        _viewModelPlanningShopsAddNewItemViewModel.smobItemSelectedLocationStr.value = "test"

        // THEN the associated LiveData observer should be triggered
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemSelectedLocationStr.getOrAwaitValue(), equalTo("test"))
    ...
    fun `setting value in MutableLiveData smobItemLatitude triggers LiveData observer`() {
        ...
        // WHEN...
        // ... setting the value of the LiveData element to be tested
        _viewModelPlanningShopsAddNewItemViewModel.smobItemlatitude.value = 1.0

        // THEN the associated LiveData observer should be triggered
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemlatitude.getOrAwaitValue(), equalTo(1.0))
    ...
    fun `setting value in MutableLiveData smobItemLongitude triggers LiveData observer`() {
        ...
        // WHEN...
        // ... setting the value of the LiveData element to be tested
        _viewModelPlanningShopsAddNewItemViewModel.smobItemlongitude.value = 1.0

        // THEN the associated LiveData observer should be triggered
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemlongitude.getOrAwaitValue(), equalTo(1.0))
    ...
    fun `calling onClear triggers all LiveData observers and sets values to null`() {
        ...
        // ... onClear is called
        _viewModelPlanningShopsAddNewItemViewModel.onClear()

        // THEN all associated LiveData observers should be triggered and the values should be null
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemTitle.getOrAwaitValue(), equalTo(null))
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemDescription.getOrAwaitValue(), equalTo(null))
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemSelectedLocationStr.getOrAwaitValue(), equalTo(null))
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemlatitude.getOrAwaitValue(), equalTo(null))
        assertThat(_viewModelPlanningShopsAddNewItemViewModel.smobItemlongitude.getOrAwaitValue(), equalTo(null))
