...
class SmobItemListFragmentTest: AutoCloseKoinTest() {
    ...
    private lateinit var shopMobItemListFragementScenario: FragmentScenario<SmobItemListFragment>
    ...
    fun setUp() {
        ...
        shopMobItemListFragementScenario = launchFragmentInContainer(Bundle(), R.style.AppTheme)

        // monitor fragmentScenario for "idling" (used to flow control the espresso tests)
        dataBindingIdlingResource.monitorFragment(
            shopMobItemListFragementScenario as FragmentScenario<Fragment>)
        ...
        shopMobItemListFragementScenario.onFragment {
    ...
    */
    ...
    fun clickSaveButton_navigateToSmobItemListFragment() {
        ...
        val saveSmobItemFragmentScenario = launchFragmentInContainer<SaveSmobItemFragment>(Bundle(), R.style.AppTheme)
    ...
    fun clickLocation_navigateToSelectLocationFragment() {
        ...
        val saveSmobItemScenario = launchFragmentInContainer<SaveSmobItemFragment>(Bundle(), R.style.AppTheme)
        // ... (with the NavController hooked up to this container)
