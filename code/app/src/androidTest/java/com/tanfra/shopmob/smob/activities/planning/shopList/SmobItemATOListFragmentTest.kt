...
import com.tanfra.shopmob.smob.activities.planning.shopEdit.PlanningShopEditFragment
...
class SmobItemATOListFragmentTest: AutoCloseKoinTest() {
    ...
    private lateinit var shopMobPlanningShopListFragementScenario: FragmentScenario<PlanningShopListFragment>
    ...
    */
    ...
    fun clickSaveButton_navigateToSmobItemListFragment() {
        ...
        val saveSmobItemFragmentScenario = launchFragmentInContainer<PlanningShopEditFragment>(Bundle(), R.style.AppTheme)
    ...
    fun clickLocation_navigateToSelectLocationFragment() {
        ...
        val saveSmobItemScenario = launchFragmentInContainer<PlanningShopEditFragment>(Bundle(), R.style.AppTheme)
        // ... (with the NavController hooked up to this container)
