...
class SmobActivityTest: AutoCloseKoinTest() {
    ...
    private fun getActivity(activityScenario: ActivityScenario<SmobActivity>): Activity? {
    ...
    fun smobActivityTest_fragmentSmobItemList() = runBlocking {
        ...
        val activityScenario = ActivityScenario.launch(SmobActivity::class.java)
        ...
        onView(withId(R.id.clSaveSmobItemFragment)).check((matches(isDisplayed())))
    ...
    fun SmobActivityTest_fragmentSaveSmobItem() = runBlocking {
        ...
        _viewModelSmob.smobItemSelectedLocationStr.postValue("Espresso test location")
