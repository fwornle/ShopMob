 ...
 */
class SmobListItemDescriptionActivity : AppCompatActivity() {

    companion object {
        private const val EXTRA_SmobItem = "EXTRA_SmobItem"

        // receive the smob item object after the user clicks on the notification
        fun newIntent(context: Context, shopMobDataItemATO: SmobListATO): Intent {
            return context.createIntent<SmobListItemDescriptionActivity>(EXTRA_SmobItem to shopMobDataItemATO)
        }
...
//                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btDismiss.setOnClickListener {
            val intent = Intent(this, SmobPlanningActivity::class.java)
