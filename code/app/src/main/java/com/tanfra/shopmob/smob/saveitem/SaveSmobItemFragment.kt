...
class SaveSmobItemFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentSaveSmobItemBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_save_smob_item, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.selectLocation.setOnClickListener {
            ...
            _viewModel.navigationCommand.value =
                NavigationCommand.To(
                    SaveSmobItemFragmentDirections.actionSaveSmobItemFragmentToSelectLocationFragment()
                )
        }
        ...
        binding.saveSmobItem.setOnClickListener {
            ...
            daSmobItemATO = SmobItemATO(
                ...
                _viewModel.smobItemlatitude.value ?: -1.0,
                _viewModel.smobItemlongitude.value ?: -1.0,
            )
        ...
        activityResultLauncherForLocationPermissionCheck = registerForActivityResult(
            ...
            when (granted) {
                ...
                true -> {
                    ...
                    Snackbar.make(
                        binding.clSaveSmobItemFragment,
    ...
    companion object {
        internal const val ACTION_GEOFENCE_EVENT =
            "SaveSmobItemFragment.ACTION_GEOFENCE_EVENT"
