...
//    val dummySmobListDTO = SmobListDTO()
    ...
    single<SmobUserRepository> { SmobUserRepository(get(), get()) }
...
//    }
    ...
    // ... the repo requires two constructor provided dependencies: dao & api
    single<SmobGroupRepository> { SmobGroupRepository(get(), get()) }
    ...
    // ... the repo requires two constructor provided dependencies: dao & api
    single<SmobShopRepository> { SmobShopRepository(get(), get()) }
    ...
    // ... the repo requires two constructor provided dependencies: dao & api
    single<SmobProductRepository> { SmobProductRepository(get(), get()) }
    ...
    // ... the repo requires two constructor provided dependencies: dao & api
    single<SmobListRepository> { SmobListRepository(get(), get()) }
