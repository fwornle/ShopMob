...
@Composable
fun PlanningShopsAddItemContent(
    ...
    Column(
        ...
        Column {
            ...
            TextField(
                ...
                label = { Text(stringResource(id = R.string.add_smob_shop_name)) },
...
//                            it.nativeKeyEvent.keyCode == KeyEvent.KEYCODE_ENTER ||
            ...
            TextField(
                ...
                label = { Text(stringResource(id = R.string.add_smob_shop_desc)) },
...
@Preview(
    name = "Planning Shops New Item",
    showSystemUi = true,
)
@Composable
fun PreviewPlanningShopsAddItem() {

    // static parameters
    val groups = listOf(Pair("id1", "item 1"), Pair("id2", "item 2"))

    ShopMobTheme {
        PlanningShopsAddItemContent(
            groupItems = groups,
            setFab = {},
