...
class SmobGroupRepository(
     ...
     */
    override fun getSmobGroup(id: String): Flow<Resource<SmobGroupATO>> {
     ...
     */
    override fun getAllSmobGroups(): Flow<Resource<List<SmobGroupATO>>> {
     ...
     */
    override suspend fun saveSmobGroup(smobGroupATO: SmobGroupATO): Unit = withContext(ioDispatcher) {
