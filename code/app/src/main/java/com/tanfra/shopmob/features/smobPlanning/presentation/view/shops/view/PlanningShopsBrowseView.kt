...
@Composable
internal fun PlanningShopsBrowseView(
    snackbarHostState: SnackbarHostState,
    shops: List<SmobShopATO>,
...
fun ListItem(
    ...
    val undoItem by remember { mutableStateOf(SmobShopATO()) }

    val coroutineScope = rememberCoroutineScope()

    // offer possibility to 'undo' item deletion (via snackbar action)
    val onShowSnackbar: (SmobShopATO) -> Unit = { daItem ->
