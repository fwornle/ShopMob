...
- [x] IMPL-2: Integrate and adjust base set of required modules from last course exercise (location reminder) to provide a fundamental structure of the app:
  ...
  - [x] IMPL-2.5: Integrate major building blocks from the course exercises (where needed for this app):
    ...
    - [x] IMPL-2.5.3: GeoFencing and notification support
        ...
        - [ ] Replace deprecated _JobIntentService_ by recommended _WorkManager_ approach 
    ...
    - [ ] IMPL-2.5.8: Develop floor plan handling (canvas)
...
- [ ] IMPL-3: App development against local DB
- [ ] IMPL-4: App development against backend DB
  - [ ] push notifications when data has changed
- [ ] IMPL-5: App development of camera access

### Project Rubics

| Category | Requirement | Milestone Mapping |
| ---------------|----------------|----------------------|
